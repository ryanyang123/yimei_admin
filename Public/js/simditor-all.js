  ...
  ImageButton = (function(_super) {
    ...
    ImageButton.prototype.renderMenu = function() {
      ...
      createInput = function() {
        ...
        return $input = $('<input type="file" title="上传图片" name="fileData"  accept="image/*">').appendTo($uploadItem);
      };
      createInput();
  ...
  ImagePopover = (function(_super) {
    ...
    ImagePopover.prototype._initUploader = function() {
      ...
      createInput = function() {
        ...
        return _this.input = $('<input type="file" title="上传图片" name="fileData" accept="image/*">').appendTo($uploadBtn);
      };
      createInput();
