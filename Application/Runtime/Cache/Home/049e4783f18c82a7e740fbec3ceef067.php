                ...
                <option value="default">默认</option>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="<?php echo U('home/'.$at.'/index');?>">卡包库</a>
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <label class="radio">
                                                <div class="radio"><span class="checked"><input type="radio"    name="optionsRadios1" value="2"></span></div>
                                                指定平台
                                            </label>
                                    ...
                                    <div class="control-group card_radio"  style="display: none;">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">发送平台</font></font></label>

                                        <div class="controls">
                                            <select name="" id="card_id" class="user_select large">
                                                <?php if(is_array($card_list)): foreach($card_list as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($list['card_id'] == $v['id']): ?>selected<?php endif; ?> ><?php echo ($v["card_name"]); ?></option><?php endforeach; endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group username_radio" style="display: none;">

                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">用户账号</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="根据用户登陆账号（多个用户 * 号隔开）" name="username"  value="<?php echo ($list["card_url"]); ?>" class="m-wrap large">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 消息标题</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="消息标题" name="title"  value="" class="m-wrap large">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">消息内容</font></font></label>

                                        <div class="controls">

                                            <textarea class="large m-wrap" id="content" rows="10" placeholder="请输入要发送的内容"></textarea>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="button" id="js_btn" onclick="SubmitData()" class="btn blue"><i class="icon-ok"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 发送</font></font></button>
...
<script>
    ...
    function SubmitData(){
        var send_type = $("input[name='optionsRadios1']:checked").val();
        ...
        $.ajax({
            ...
            data:{send_type:send_type,username:username,title:title,card_id:card_id,content:content,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
