                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if($v["status"] == 1): ?><span class="label label-success">已售出</span><?php endif; ?>
                                                        <?php if($v["status"] == 2): ?><span class="label label-warning">已失效</span><?php endif; ?>

                                                        <?php if($v["status"] == 0): ?><span class="label label-important">待出售</span><?php endif; ?>
                                                    </td>

                                                    <td>
                                                        <?php if($v["order_id"] == 0): ?>-
                                                            <?php else: ?>
                                                            <a target="_blank" href="<?php echo U('home/orderlist/check/edit/'.$v['order_id']);?>">点击查看</a><?php endif; ?>
                                                    ...
                                                    <td>
                                                        <?php if($v["status"] == 0): ?><a href="<?php echo U('home/'.$at.'/plus/edit/'.$v['id']);?>" class="btn blue"><i class="icon-edit"></i> 修改</a>
                                                            <a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','卡包库','stock');" class="btn red"><i class="icon-trash"></i> 删除</a><?php endif; ?>
