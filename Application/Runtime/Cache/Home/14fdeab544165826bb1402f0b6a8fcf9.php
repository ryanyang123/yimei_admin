                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php echo ($v["event_number"]); ?>
                                                    </td>

                                                    <td>
                                                        <?php if($v['status'] == 1): ?><span class="label">等待客户经理操作</span><?php endif; ?>
                                                        <?php if($v['status'] == 2): ?><span class="label label-warning">已申请</span><?php endif; ?>
                                                        <?php if($v['status'] == 3): ?><span class="label label-success">已添加</span><?php endif; ?>
                                                        <?php if($v['status'] == 4): ?><span class="label">用户不存在</span><?php endif; ?>
                                                        <?php if($v['status'] == 5): ?><span class="label">协助跟进</span><?php endif; ?>
                                                        <?php if($v['status'] == 6): ?><span class="label label-important">关单-原因：<?php echo ($v["cause"]); ?></span><?php endif; ?>
                                                        <?php if($v['status'] == 7): ?><span class="label label-info">已完成</span><?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php echo ($v["manager_name"]); ?>
                                                    </td>
                                                    <td>
                                                        <?php if($v['type'] == 1): ?>客服指定
                                                            <?php else: ?>
                                                            默认分配<?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo ($v["user_contact"]); ?>
                                                    </td>

                                                    <td>
                                                        <?php echo ($v["user_keyword"]); ?>
                                                    </td>
                                                    <!--<td>
                                                        <?php echo ($v["user_remark"]); ?>
                                                    </td>-->
                                                    <td>
                                                        <?php if($v['is_guid'] == 1): ?><span class="label label-success">是</span>
                                                            <?php else: ?>
                                                            <span class="label label-important">否</span><?php endif; ?>
                                                    </td>

                                                    <td>
                                                        <?php if($v['is_add'] == 1): ?><span class="label label-success">是</span>
                                                            <?php else: ?>
                                                            <span class="label label-important">否</span><?php endif; ?>
                                                    </td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <?php if($v["status"] == 6 or $v["status"] == 7): ?><a href="javascript:jihuo('<?php echo ($v["id"]); ?>')" class="btn blue"><i class="icon-off"></i> 激活</a><?php endif; ?>
                                                      <!--  <?php if($v["status"] == 0): ?><a href="<?php echo U('home/'.$at.'/plus/edit/'.$v['id']);?>" class="btn blue"><i class="icon-edit"></i> 修改</a>
                                                            <a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','事件列表','stock');" class="btn red"><i class="icon-trash"></i> 删除</a><?php endif; ?>-->
