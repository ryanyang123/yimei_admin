                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php if($v['from'] == 1): ?><span class="label label-info">群</span><?php endif; ?>
                                                        <?php if($v['from'] == 2): ?><span class="label label-info">大</span><?php endif; ?>
                                                        <?php if($v['from'] == 3): ?><span class="label label-info">内</span><?php endif; ?>
                                                        <?php if($v['from'] == 4): ?><span class="label label-info">首</span><?php endif; ?>
                                                        <?php if($v['from'] == 5): ?><span class="label label-info">月</span><?php endif; ?>
                                                        <?php if($v['from'] == 6): ?><span class="label label-info">推</span><?php endif; ?>
                                                        <?php if($v['from'] == 7): ?><span class="label label-info">赠</span><?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo ($v["card_num"]); ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                         ￥<?php echo ($v["card_money"]); ?>
                                                    </td>
                                                    <td>
                                                        ￥<?php echo ($v["cost"]); ?>
                                                    </td>
                                                    <td>
                                                        <?php if($v['status'] == 0): ?><span class="label">待生成链接</span><?php endif; ?>
                                                        <?php if($v['status'] == 1): ?><span class="label label-warning">待用户领卡</span><?php endif; ?>
                                                        ...
                                                        <?php if($v['status'] == 4): ?><span class="label label-info">首次购买记录</span><?php endif; ?>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <?php if($v['pay_type'] == 4): ?><span class="label label-warning">月卡领卡</span><?php endif; ?>
                                                        <?php if($v['pay_type'] == 5): ?><span class="label label-warning">活动赠送</span><?php endif; ?>
                                                        <?php if($v['pay_type'] == 6): ?><span class="label label-warning">VIP赠送</span><?php endif; ?>
                                                    </td>
                                                   <!-- <td style="width:35%">
                                                    ...
                                                    <td><?php echo (date("Y-m-d H:i",$v["pay_time"])); ?></td>
                                                  <td>
                                                      <a href="<?php echo U('home/'.$at.'/check/edit/'.$v['id']);?>" class="btn green"><i class="icon-eye-open"></i> 查看详细</a>
                                                      <!--  <?php if($v["status"] == 0): ?><a href="<?php echo U('home/'.$at.'/plus/edit/'.$v['id']);?>" class="btn blue"><i class="icon-edit"></i> 修改</a>
                                                            <a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','订单列表','stock');" class="btn red"><i class="icon-trash"></i> 删除</a><?php endif; ?>-->
