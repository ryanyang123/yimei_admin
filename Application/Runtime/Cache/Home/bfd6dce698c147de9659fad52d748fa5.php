            ...
            <select class="header-option m-wrap small">
                ...
                <option value="default">默认</option>
                    ...
                    <h3 class="page-title">
                        ...
                        修改密码 <small><?php echo session(XUANDB.'user_name');?></small>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">当前密码</font></font></label>

                                        <div class="controls">

                                            <input type="password" placeholder="请输入当前密码" name="oldpwd"  value="" class="m-wrap medium">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="password" placeholder="请输入新密码" name="pwd"  value="" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="password" placeholder="确认密码" name="pwd2"  value="" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="button" id="js_btn" onclick="SubmitData()" class="btn blue"><i class="icon-ok"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 修改</font></font></button>
...
<script>
    ...
    var parent_url = "<?php echo U('home/editpass/index');?>";
    ...
    function SubmitData(){
        ...
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: "<?php echo U('home/editpass/edit'); ?>",
            data:{oldpwd:oldpwd,pwd:pwd},
            success: function (result) {
                if(result.code == 1){
                    showAlert(result.res);
                    window.location.href= '<?php echo U("home/editpass/index");?>';
