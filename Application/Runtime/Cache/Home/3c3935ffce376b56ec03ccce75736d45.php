                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php if($v['status'] == 0): ?><span class="label">用户生成链接，待处理</span><?php endif; ?>
                                                        <?php if($v['status'] == 1): ?><span class="label label-warning">生成链接，等待用户领取</span><?php endif; ?>
                                                        ...
                                                        <?php if($v['status'] == 4): ?><span class="label">用户链接无卡</span><?php endif; ?>
                                                    </td>
                                                  ...
                                                  <td>
                                                      ...
                                                      <!--  <?php if($v["status"] == 0): ?><a href="<?php echo U('home/'.$at.'/plus/edit/'.$v['id']);?>" class="btn blue"><i class="icon-edit"></i> 修改</a>
                                                            <a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','置换列表','stock');" class="btn red"><i class="icon-trash"></i> 删除</a><?php endif; ?>-->
