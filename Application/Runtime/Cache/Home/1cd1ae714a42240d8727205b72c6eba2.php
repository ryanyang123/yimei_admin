                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">车辆类型图标</font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $is_edit?'修改车辆类型图标':'上传车辆类型图标';?></font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">车辆类型名称</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入车辆类型名称" name="name"  value="<?php echo ($list["name"]); ?>" class="m-wrap medium">
                                        </div>
...
<script>
    ...
    function SubmitData(img){
        ...
        $.ajax({
            ...
            data:{name:name,img:img,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
