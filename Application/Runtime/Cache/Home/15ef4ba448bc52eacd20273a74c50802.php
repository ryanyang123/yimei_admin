                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">上/下车分类名称</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入上/下车分类名称" name="name"  value="<?php echo ($list["name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="s_type" id="s_type" style="line-height: 34px;height: 34px;">


                                                <option <?php if($list['type'] == 1): ?>selected<?php endif; ?> value="1" >上车地点分类</option>
                                                <option <?php if($list['type'] == 2): ?>selected<?php endif; ?> value="2" >下车地点分类</option>
...
<script>
    ...
    function SubmitData(){
        ...
        $.ajax({
            ...
            data:{name:name,type:s_type,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
