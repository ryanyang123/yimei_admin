                    ...
                    <div class="tabbable tabbable-custom tabbable-full-width">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab_1_5" class="tab-pane active">
                                ...
                                <div style="border-bottom: 1px solid #ccc;padding: 10px 10px 0;;margin-bottom: 20px;font-size: 15px;">
                                    <p style="font-weight: bolder;">VIP系统当前状态:
                                        <?php if($is_status['status'] == 0): ?><span style="color: red;">关闭 </span>
                                            <?php else: ?>
                                            <span style="color: #008000;">打开 </span>
                                            <span style="margin-left: 30px;font-weight: normal;">
                                                 <?php if($is_status['status'] == 1): ?>开启类型：永久开启<?php endif; ?>

                                                <?php if($is_status['status'] == 2): ?>开启类型：时间段开启
                                                    <span style="margin-left: 30px;">开启时间段:</span>
                                                    <span style="color: #666;margin-right: 30px;">
                                                        <span style="color: #107EFD;"><?php echo (date("Y-m-d H:i",$is_status["start_time"])); ?></span>
                                                         &nbsp;&nbsp;至&nbsp;&nbsp;
                                                        <span style="color: #107EFD;"><?php echo (date("Y-m-d H:i",$is_status["end_time"])); ?></span>
                                                    </span>
                                                    当前时间是否在活动时间内：
                                                    <?php echo ($is_status["is_now"]); endif; ?>
                                            </span><?php endif; ?>
                                        <a href="<?php echo U('home/set/index/type/2');?>" style="margin-left: 20px;">
                                            前往设置 →
                                        </a>
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--<a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','VIP','card');" class="btn red"><i class="icon-trash"></i> 删除</a>-->
                                                    </td>
