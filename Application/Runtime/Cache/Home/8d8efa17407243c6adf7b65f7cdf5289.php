            ...
            <select class="header-option m-wrap small">
                ...
                <option value="default">默认</option>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#"><?php echo ($list["huan_number"]); ?></a></li>
                    </ul>
                                        ...
                                        <table class="table table-bordered table-hover tc_table" >
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo ($list["card2_name"]); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($list["card2_num"]); ?>
                                                        </td>

                                                        <td>
                                                            <?php if($list['status'] == 0): ?><span class="label">用户生成链接，待处理</span><?php endif; ?>
                                                            <?php if($list['status'] == 1): ?><span class="label label-warning">生成链接，等待用户领取</span><?php endif; ?>
                                                            ...
                                                            <?php if($list['status'] == 4): ?><span class="label">用户链接无卡</span><?php endif; ?>
                                                        </td>
                    ...
                    <ul class="timeline" id="show">
                        <?php if(is_array($log_list)): foreach($log_list as $key=>$v): ?><li class="timeline-grey">
                                ...
                                <div class="timeline-body">
                                    ...
                                    <p class="time_p1">
                                        <?php if($v["type"] == 1): echo ($v["content"]); ?> , 提交至 订单处理系统
                                        ...
                                        <?php if($v["type"] == 4): echo ($v["content"]); ?> , 提交至 订单处理系统<?php endif; ?>
                                        <?php if($v["type"] == 5): echo ($v["content"]); ?> , 提交至 订单处理系统<?php endif; ?>
