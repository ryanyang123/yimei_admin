                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <a class="fancybox-button" data-rel="fancybox-button" title="" href="<?php echo ($v["img_url"]); ?>">
                                                            <img src="<?php echo ($v["img_url"]); ?>" class="img45" alt="">
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <?php if($v["type"] == 1): ?>首页轮播图<?php endif; ?>
                                                        <?php if($v["type"] == 2): ?>弹出广告<?php endif; ?>
                                                    </td>

                                                    <td><?php echo ($v["title"]); ?></td>
                                                    <td><?php echo ($v["sort"]); ?></td>
                                                    <td>
                                                        <?php if($v["is_show"] == 1): ?><a href="javascript:EditStatus('<?php echo ($v["id"]); ?>','0','广告','banner')">
                                                                <span class="label label-success"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">显示</font></font></span>
                                                            </a><?php endif; ?>

                                                        <?php if($v["is_show"] == 0): ?><a href="javascript:EditStatus('<?php echo ($v["id"]); ?>','1','广告','banner')">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','广告','banner');" class="btn red"><i class="icon-trash"></i> 删除</a>
                                                        <!--<a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','广告列表','card');" class="btn red"><i class="icon-trash"></i> 删除</a>-->
                                                    </td>
