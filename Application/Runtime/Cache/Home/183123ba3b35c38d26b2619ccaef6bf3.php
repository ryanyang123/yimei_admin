                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        ￥<?php echo ($v["generalize"]); ?>
                                                    </td>
                                                    <td>
                                                        ￥<?php echo ($v["wage"]); ?>
                                                    </td>
                                                    <td>
                                                        ￥<?php echo ($v["fixed_assets"]); ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php if($v["total_win"] > 0): ?><span style="color: #008000;">+<?php echo ($v["total_win"]); ?></span><?php endif; ?>
                                                        <?php if($v["total_win"] < 0): ?><span style="color: red;"> <?php echo ($v["total_win"]); ?></span><?php endif; ?>
                                                        <?php if($v["total_win"] == 0): ?><span style="color: #0000ff;"><?php echo ($v["total_win"]); ?></span><?php endif; ?>

                                                    </td>

                                                    <td><?php echo (date("Y-m-d H:i",$v["create_time"])); ?></td>
                                                    <td>
                                                        <?php if($v["status"] == 0): ?><a href="<?php echo U('home/'.$at.'/plus/edit/'.$v['id']);?>" class="btn blue"><i class="icon-edit"></i> 修改</a><?php endif; ?>
