                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">购卡平台</font></font></label>

                                        <div class="controls">
                                            <select name="" id="card_id" class="user_select">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">房卡包地址</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入房卡包地址" name="card_url"  value="<?php echo ($list["card_url"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">房卡数量</font></font></label>

                                        <div class="controls">

                                            <input type="text" placeholder="请输入房卡数量" name="num"  value="<?php echo ($list["num"]); ?>" class="m-wrap medium">
...
<script>
    ...
    function SubmitData(){
        var card_url = $.trim($("*[name='card_url']").val());
        ...
        $.ajax({
            ...
            data:{card_url:card_url,num:num,card_id:card_id,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
