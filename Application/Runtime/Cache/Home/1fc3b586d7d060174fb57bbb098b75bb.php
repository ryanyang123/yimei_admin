                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">所属地点分类</font></font></label>

                                        <div class="controls">
                                            <select name="type_id" id="type_id" style="line-height: 34px;height: 34px;">

                                                <?php if(is_array($type_list)): foreach($type_list as $key=>$v): ?><option <?php if($list['type_id'] == $v['id']): ?>selected<?php endif; ?> value="<?php echo ($v["id"]); ?>" ><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">上车地点</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入上车地点" name="name"  value="<?php echo ($list["name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">增加价格</font></font></label>

                                        <div class="controls">
                                            <input type="number" placeholder="请输入增加价格" name="price"  value="<?php echo ($list["price"]); ?>" class="m-wrap medium">
                                        </div>
...
<script>
    ...
    function SubmitData(){
        ...
        $.ajax({
            ...
            data:{name:name,price:price,type_id:type_id,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
