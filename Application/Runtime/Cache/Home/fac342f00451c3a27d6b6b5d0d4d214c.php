                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">下车地点</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入下车地点" name="name"  value="<?php echo ($list["name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">价格</font></font></label>

                                        <div class="controls">
                                            <input type="number" placeholder="请输入价格" name="price"  value="<?php echo ($list["price"]); ?>" class="m-wrap medium">
                                        </div>
