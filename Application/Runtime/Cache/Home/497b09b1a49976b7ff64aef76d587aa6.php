                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">司机照片</font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $is_edit?'修改司机照片':'上传司机照片';?></font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">司机名称</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入司机名称" name="name"  value="<?php echo ($list["name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">司机手机号</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入司机手机号" name="phone"  value="<?php echo ($list["phone"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">司机司机身份证号</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入司机身份证号" name="id_card"  value="<?php echo ($list["id_card"]); ?>" class="m-wrap medium">
                                        </div>
...
<script>
    ...
    function SubmitData(img){
        ...
        $.ajax({
            ...
            data:{name:name,phone:phone,id_card:id_card,img:img,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
