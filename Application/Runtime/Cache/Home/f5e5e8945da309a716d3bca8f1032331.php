                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php if($v['type'] == 1): ?>上车地点分类<?php endif; ?>
                                                        <?php if($v['type'] == 2): ?>下车地点分类<?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!--<a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','上车地点分类','card');" class="btn red"><i class="icon-trash"></i> 删除</a>-->
                                                    </td>
