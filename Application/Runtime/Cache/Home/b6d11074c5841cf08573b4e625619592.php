                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">活动标题</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入活动标题" name="title"  value="<?php echo ($list["title"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">活动内容</font></font></label>
...
<script src="/taxihailing_cms/Public/duoimg/js/webuploader.min.js"></script>
<script>
    ...
    function SubmitData(content){
        ...
        $.ajax({
            ...
            data:{title:title,content:content,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
