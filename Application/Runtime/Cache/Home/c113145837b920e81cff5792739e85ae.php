                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 860px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php if($v["type"] == 1): ?>所用用户<?php endif; ?>
                                                        <?php if($v["type"] == 2): ?>指定平台 - <?php echo ($v["card_name"]); endif; ?>
                                                        <?php if($v["type"] == 3): ?>指定用户 - <?php echo ($v["user_name"]); endif; ?>
                                                    </td>
...
-->
                                                        <a href="JavaScript:_deleteUser('<?php echo ($v["send_key"]); ?>','系统公告','system');" class="btn red"><i class="icon-trash"></i> 删除</a>
