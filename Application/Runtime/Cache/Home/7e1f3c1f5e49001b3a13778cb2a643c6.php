                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">月卡名称</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入价格" name="month_name"  value="<?php echo ($list["month_name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" placeholder="请输入价格" name="price"  value="<?php echo ($list["price"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">每天赠送数量</font></font></label>

                                        <div class="controls">

                                            <input type="number" placeholder="请输入每天赠送数量" name="num"  value="<?php echo ($list["num"]); ?>" class="m-wrap medium">
                                        </div>
...
<script>
    ...
    function SubmitData(){
        var month_name = $.trim($("*[name='month_name']").val());
        ...
        $.ajax({
            ...
            data:{month_name:month_name,price:price,num:num,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
