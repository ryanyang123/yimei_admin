            ...
            <select class="header-option m-wrap small">
                ...
                <option value="default">默认</option>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#"><?php echo ($list["wx_id"]); ?> ----- 登陆日志</a></li>
                            ...
                            <div id="tab_2_2" class="tab-pane active">
                                <div class="portlet-body" style="width: 100%;">
                                    ...
                                    <table class="table table-bordered table-hover tc_table" >
                                        ...
                                        <tbody>
                                        <?php if($log_list): if(is_array($log_list)): foreach($log_list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php if($v["country"] != null): echo ($v["country"]); ?>
                                                            <?php else: ?>
                                                            -<?php endif; ?>
                                                    </td>

                                                    <td>
                                                        <?php if($v["province"] != null): echo ($v["province"]); ?>
                                                            <?php else: ?>
                                                            -<?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <?php if($v["city"] != null): echo ($v["city"]); ?>
                                                            <?php else: ?>
                                                            -<?php endif; ?>
                                                    </td>

                                                    <td>
                                                        <?php if($v["operator"] != null): echo ($v["operator"]); ?>
                                                            <?php else: ?>
                                                            -<?php endif; ?>
                                                    </td>
