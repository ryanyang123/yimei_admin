                                    ...
                                    <div class="portlet-body" style="width: 100%;">
                                        ...
                                        <table class="table table-bordered table-hover tc_table" >
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <?php echo ($list["order_number"]); ?>
                                                    </td>
                                                        <td>
                                                            <?php echo ($list["card_name"]); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($list["wx_id"]); ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php if($list['from'] == 1): ?><span class="label label-info">群</span><?php endif; ?>
                                                            <?php if($list['from'] == 2): ?><span class="label label-info">大</span><?php endif; ?>
                                                            <?php if($list['from'] == 3): ?><span class="label label-info">内</span><?php endif; ?>
                                                            <?php if($list['from'] == 4): ?><span class="label label-info">首</span><?php endif; ?>
                                                            <?php if($list['from'] == 5): ?><span class="label label-info">月</span><?php endif; ?>
                                                            <?php if($list['from'] == 6): ?><span class="label label-info">推</span><?php endif; ?>
                                                            <?php if($list['from'] == 7): ?><span class="label label-info">赠</span><?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($list["card_num"]); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo ($list["give_num"]); ?>
                                                        </td>
                                                        <td>
                                                            ￥<?php echo ($list["card_money"]); ?>
                                                        </td>
                                                        <td>
                                                            ￥<?php echo ($list["cost"]); ?>
                                                        </td>
                                                        <td>
                                                            <?php if($list['status'] == 0): ?><span class="label">待生成链接</span><?php endif; ?>
                                                            <?php if($list['status'] == 1): ?><span class="label label-warning">待用户领卡</span><?php endif; ?>
                                                            <?php if($list['status'] == 2): ?><span class="label label-success">已领卡</span><?php endif; ?>
                                                            <?php if($list['status'] == 3): ?><span class="label label-important">领卡异常</span><?php endif; ?>
                                                            <?php if($list['status'] == 4): ?><span class="label label-info">首次购买记录</span><?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($list['pay_type'] == 1): ?><span class="label label-success">微信</span><?php endif; ?>
                                                            <?php if($list['pay_type'] == 2): ?><span class="label label-info">支付宝</span><?php endif; ?>
                                                            <?php if($list['pay_type'] == 3): ?><span class="label label-warning">银行转账</span><?php endif; ?>
                                                            <?php if($list['pay_type'] == 4): ?><span class="label label-warning">月卡领卡</span><?php endif; ?>
                                                            <?php if($list['pay_type'] == 5): ?><span class="label label-warning">活动赠送</span><?php endif; ?>
                                                            <?php if($list['pay_type'] == 6): ?><span class="label label-warning">VIP赠送</span><?php endif; ?>
                                                        </td>
                                                        <!-- <td style="width:35%">
                                                        ...
                                                        <td>
                                                            <?php if($list["admin_name"] == null): ?>-
                                                                <?php else: ?>
                                                                <?php echo ($list["admin_name"]); endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($list["vip_name"] == null): ?>无
                                                                <?php else: ?>
                                                                <?php echo ($list["vip_name"]); endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($list["discount"] == 0): ?>无
                                                                <?php else: ?>
                                                                <?php echo ($list["discount"]); ?> %<?php endif; ?>

                                                        </td>
                                                        <td>
                                                            <?php if($list["stock_id"] == 0): ?>未使用
                                                                <?php else: ?>
                                                                <a href="<?php echo U('home/stock/index/id/'.$list['stock_id']);?>" target="_blank">已使用，点击查看</a><?php endif; ?>
                                                        </td>
                    ...
                    <ul class="timeline" id="show">
                        <?php if(is_array($log_list)): foreach($log_list as $key=>$v): ?><li class="timeline-grey">
                                ...
                                <div class="timeline-body">
                                    ...
                                    <p class="time_p1">
                                        <?php if($v["type"] == 1): echo ($v["content"]); ?> , 提交至 订单处理系统<?php endif; ?>
                                        <?php if($v["type"] == 2): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); ?>
                                            <?php if($v["remark"] != null): ?>&nbsp;&nbsp;房卡地址 :  <span onclick="myCopy('<?php echo ($v["id"]); ?>')"><?php echo ($v["remark"]); ?></span>
                                                <input type="text" class="hide_text_inp" value="<?php echo ($v["remark"]); ?>" id="inp_url<?php echo ($v["id"]); ?>"/><?php endif; endif; ?>
                                        <?php if($v["type"] == 3): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); endif; ?>
                                        <?php if($v["type"] == 4): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); ?> , 反馈至 订单处理系统
                                            <?php if($v["remark"] != null): ?>&nbsp;&nbsp;房卡地址 : <span onclick="myCopy('<?php echo ($v["id"]); ?>')"><?php echo ($v["remark"]); ?></span>
                                                <input type="text" class="hide_text_inp" value="<?php echo ($v["remark"]); ?>" id="inp_url<?php echo ($v["id"]); ?>"/><?php endif; endif; ?>
                                        <?php if($v["type"] == 5): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); ?> , 提交至 订单处理系统<?php endif; ?>
                                        <?php if($v["type"] == 6): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); ?>
                                            <?php if($v["remark"] != null): ?>&nbsp;&nbsp;房卡地址 : <span onclick="myCopy('<?php echo ($v["id"]); ?>')"><?php echo ($v["remark"]); ?></span>
                                                <input type="text" class="hide_text_inp" value="<?php echo ($v["remark"]); ?>" id="inp_url<?php echo ($v["id"]); ?>"/><?php endif; endif; ?>
                                        <?php if($v["type"] == 7): echo ($v["content"]); endif; ?>
                                        <?php if($v["type"] == 8): echo ($v["content"]); ?>
                                            <?php if($v["remark"] != null): ?>&nbsp;&nbsp;房卡地址 : <span onclick="myCopy('<?php echo ($v["id"]); ?>')"><?php echo ($v["remark"]); ?></span>
                                                <input type="text" class="hide_text_inp" value="<?php echo ($v["remark"]); ?>" id="inp_url<?php echo ($v["id"]); ?>"/><?php endif; endif; ?>

                                        <?php if($v["type"] == 9): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); endif; ?>

                                        <?php if($v["type"] == 10): ?><span class="span_blue"><?php echo ($v["admin_name"]); ?></span><?php echo ($v["content"]); endif; ?>
                                        <?php if($v["type"] == 11): echo ($v["content"]); endif; ?>
                                        <?php if($v["type"] == 12): echo ($v["content"]); endif; ?>
                                        <?php if($v["type"] == 13): echo ($v["content"]); endif; ?>
                                        <?php if($v["type"] == 14): echo ($v["content"]); endif; ?>
                                      <!--  <?php if($v["type"] == 111): ?><span class="span_blue"><?php echo ($v["service_name"]); ?></span><?php echo ($v["content"]); ?> , 提交至 <span class="span_blue"><?php echo ($v["manager_name"]); ?></span>
