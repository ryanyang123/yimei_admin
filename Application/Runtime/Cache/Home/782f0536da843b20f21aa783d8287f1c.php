...
<div class="page-container">
    ...
    <ul class="page-sidebar-menu">
        ...
        <?php if($limit_list["1"] == 1 or $limit_list["type"] == 1): ?><li class="last <?php echo $at== 'service'?'active':'';?>">
                <a href="<?php echo U('home/service/index');?>">
                    <i class="icon-headphones"></i>
                    <span class="title">客服值班页面</span>
        ...
        <?php if($limit_list["2"] == 1 or $limit_list["type"] == 1): ?><li class="last <?php echo $at== 'manager'?'active':'';?>">
            <a href="<?php echo U('home/manager/index');?>">
                <i class="icon-road"></i>
                <span class="title">客户经理值班页面</span>
        ...
        <li class="<?php echo$at == 'user' || $at == 'user2' ?'active':'';?>">
            ...
            <ul class="sub-menu">
                ...
                <li class="last <?php echo $at == 'user'?'active':'';?>">
                    <a href="<?php echo U('home/user/index');?>">
                        <span class="title">有账号用户</span>

                    </a>

                </li>

                <li class="last <?php echo $at == 'user2'?'active':'';?>">
                    <a href="<?php echo U('home/user2/index');?>">
                        <span class="title">归档用户</span>
                ...
                <option value="default">默认</option>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="<?php echo U('home/'.$at.'/index');?>">其他成本录入</a>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">日期</font></font></label>


                                        <div class="controls">
                                            <?php if(empty($is_edit) != true): ?><p id="add_time_p" style="padding-top: 7px;margin-bottom: 0;"><?php echo (date('Y-m-d',$list["add_time"])); ?></p>
                                                <?php else: ?>
                                                <input type="text" placeholder="请选择要录入的日期" name="add_time" readonly  <?php if($list["add_time"] != null): ?>value="<?php echo (date('Y-m-d',$list["add_time"])); ?>"<?php endif; ?>  class="m-wrap medium auto-kal"><?php endif; ?>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">推广成本</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入推广成本（元）" name="generalize"  value="<?php echo ($list["generalize"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">工资成本</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入工资成本（元）" name="wage"  value="<?php echo ($list["wage"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">固资成本</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入固资成本（元）" name="fixed_assets"  value="<?php echo ($list["fixed_assets"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">办公成本</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入办公成本（元）" name="work"  value="<?php echo ($list["work"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">其他成本A</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入其他成本A（元）" name="other1"  value="<?php echo ($list["other1"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">其他成本B</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入其他成本B（元）" name="other2"  value="<?php echo ($list["other2"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">其他成本C</font></font></label>
                                        <div class="controls">
                                            <input type="text" placeholder="请输入其他成本C（元）" name="other3"  value="<?php echo ($list["other3"]); ?>" class="m-wrap medium">
                                        </div>
                                    </div>
...
<script>
    ...
    function SubmitData(){
        var add_time;
        if(is_Edit){
            add_time = $('#add_time_p').html();
        }else{
            add_time = $.trim($("*[name='add_time']").val());
        }

        var generalize = $.trim($("*[name='generalize']").val());
        var wage = $.trim($("*[name='wage']").val());
        var fixed_assets = $.trim($("*[name='fixed_assets']").val());
        var work = $.trim($("*[name='work']").val());
        var other1 = $.trim($("*[name='other1']").val());
        var other2 = $.trim($("*[name='other2']").val());
        var other3 = $.trim($("*[name='other3']").val());
