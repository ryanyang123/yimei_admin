                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">平台图标</font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $is_edit?'修改平台图标':'上传平台图标';?></font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">平台名称</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入平台名称" name="card_name"  value="<?php echo ($list["card_name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">成本价</font></font></label>

                                        <div class="controls">

                                            <input type="text" placeholder="请输入成本价" name="cost"  value="<?php echo ($list["cost"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">平台地址</font></font></label>

                                        <div class="controls">

                                            <input type="text" placeholder="请输入平台地址" name="url"  value="<?php echo ($list["url"]); ?>" class="m-wrap medium">
                                        </div>
...
<script>
    ...
    function SubmitData(img){
        var card_name = $.trim($("*[name='card_name']").val());
        var cost = $.trim($("*[name='cost']").val());
        ...
        $.ajax({
            ...
            data:{card_name:card_name,cost:cost,url:url,img:img,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
