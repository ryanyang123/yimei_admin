...
<div class="page-container">
    ...
    <ul class="page-sidebar-menu">
        ...
        <li class="last <?php echo $at == 'order'?'active':'';?>">
            <a href="<?php echo U('home/order/index');?>">
                <i class="icon-credit-card"></i>
        ...
        <li class="last <?php echo $at == 'opinion'?'active':'';?>">
            <a href="<?php echo U('home/opinion/index');?>">
                <i class="icon-credit-card"></i>
                <span class="title">反馈列表</span>
                                   ...
                                   <form class="form-search" method="get" action="<?php echo U('home/'.$at.'/index');?>">
                                        ...
                                        <div class="chat-form clearfix">
                                            ...
                                            <div class="input-cont" style="width:100%;float: left;margin-right: 20px;margin-bottom: 2px;min-width: 210px;">
                                                ...
                                                <input type="text" placeholder="搜索 订单编号" value="<?php echo ($search_list["search"]); ?>" name="search" class="m-wrap large">
                                                <input type="text" placeholder=" 根据用户ID搜索" value="<?php echo ($search_list["user_id"]); ?>" name="user_id" class="m-wrap large">

                                                <select name="type_id" id="" style="line-height: 34px;height: 34px;">
                                                    <option value="" disabled >类型筛选</option>
                                                    <option value="0" >全部</option>
                                                    <option <?php if($search_list['type_id'] == 1): ?>selected<?php endif; ?> value="1" >跨境专车</option>
                                                    <option <?php if($search_list['type_id'] == 2): ?>selected<?php endif; ?> value="2" >包车</option>
                                                </select>

                                                <select name="status" id="" style="line-height: 34px;height: 34px;">
                                                    <option value="" disabled >处理状态筛选</option>
                                                    <option value="0" >全部</option>
                                                    <option <?php if($search_list['status'] == 2): ?>selected<?php endif; ?> value="2" >已安排</option>
                                                    <option <?php if($search_list['status'] == 1): ?>selected<?php endif; ?> value="1" >未安排</option>
                                                </select>

                                                <input type="text" placeholder="支付开始时间 " value="<?php echo ($search_list["search_date"]); ?>" name="search_date" class="m-wrap large auto-kal">
                                                <input type="text" placeholder="支付结束时间 " value="<?php echo ($search_list["search_date2"]); ?>" name="search_date2" class="m-wrap large auto-kal">
                                            </div>
                                ...
                                <div class="portlet-body" style="overflow: auto;">
                                    ...
                                    <table class="table table-striped table-hover" style="min-width: 1500px;">
                                        ...
                                        <?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                                    ...
                                                    <td>
                                                        <?php if($v["type"] == 1): ?><span class="label label-success">跨境专车</span>
                                                            <?php else: ?>
                                                            <span class="label label-info">包车</span><?php endif; ?>

                                                    </td>
                                                    <td><?php echo ($v["user_id"]); ?></td>
                                                    <td>￥<?php echo ($v["money"]); ?></td>
                                                    <td><?php echo ($v["phone"]); ?></td>
                                                    <td style="width: 12%;"><?php echo ($v["shang"]); ?>  <?php echo ($v["shang_location"]); ?></td>
                                                    <td style="width: 12%;">
                                                        <?php if($v["type"] == 1): echo ($v["xia"]); ?>  <?php echo ($v["xia_location"]); ?>
                                                            <?php else: ?>
                                                            --<?php endif; ?>
                                                    ...
                                                    <td>
                                                        <?php if($v["type"] == 1): ?>--
                                                            <?php else: ?>
                                                            <?php if($v["bao_type"] == 1): ?>2小时<?php endif; ?>
                                                            <?php if($v["bao_type"] == 2): ?>4小时<?php endif; endif; ?>
                                                    </td>

                                                    <td>
                                                        <?php if($v["an_type"] == 1): ?>深圳湾口岸<?php endif; ?>
                                                        <?php if($v["an_type"] == 2): ?>皇岗口岸<?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td><?php echo (date("Y-m-d H:i:s",$v["go_time"])); ?></td>

                                                    <td><?php echo (date("Y-m-d H:i:s",$v["create_time"])); ?></td>
                                                    <td>
                                                        <?php if($v["status"] == 0): ?><a href="javascript:UserGuid('<?php echo ($v["id"]); ?>','<?php echo ($v["order_number"]); ?>');" class="btn blue"><i class="icon-edit"></i> 安排</a><?php endif; ?>
<!--
                                                        <a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','订单','order');" class="btn red"><i class="icon-trash"></i> 删除</a>
-->
                                                        <!--<a href="JavaScript:_deleteUser('<?php echo ($v["id"]); ?>','订单管理','card');" class="btn red"><i class="icon-trash"></i> 删除</a>-->
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="14">
                                                        <p style="padding-left: 50px;">
                                                            安排详情：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <?php if($v["status"] == 0): ?><span class="label label-important">等待安排</span>
                                                                <?php else: ?>
                                                            司机：<?php echo ($v["driver_name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            车辆：<?php echo ($v["vehicle_name"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <?php if($v["remark"] != null): ?>备注：<?php echo ($v["remark"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <?php else: ?>
                                                                    备注：无&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
                                                            处理时间：<?php echo (date("Y-m-d H:i:s",$v["arrange_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
                                                        </p>
    ...
    <div class="modal-dialog" >
        <div class="modal-content" >
            <div class="modal-header">
                ...
                <h4 class="modal-title" id='modal_guid_title'>安排用户行程</h4>
            </div>
            <div class="modal-body" style="min-height: 270px;">
                ...
                <form action="#" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">分配司机</font></font></label>
                        <div class="controls">
                            <select name="guid_card_id" data-placeholder="Your Favorite Type of Bear" class="chosen-with-diselect large" tabindex="-1" id="driver_id">
                                <option value="0" selected >请选择</option>
                                <?php if(is_array($driver_list)): foreach($driver_list as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?> - <?php echo ($v["phone"]); ?></option><?php endforeach; endif; ?>
                    ...
                    <div class="control-group">
                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">分配车辆</font></font></label>
                        <div class="controls">
                            <select name="guid_card_id" data-placeholder="Your Favorite Type of Bear" class="chosen-with-diselect large" tabindex="-1" id="vehicle_id">
                                <option value="0" selected >请选择</option>
                                <?php if(is_array($vehicle_list)): foreach($vehicle_list as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["vehicle_number"]); ?></option><?php endforeach; endif; ?>
                    ...
                    <div class="control-group">
                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">备注</font></font></label>
                        <div class="controls">
                            <textarea class="m-wrap" rows="3" id="an_remark" placeholder="显示至用户订单,空则不显示"></textarea>
...
<script>
    ...
    function AnPai(id){
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo U('home/'.$at.'/anpai'); ?>",
            data:{id:id,driver_id:driver_id,vehicle_id:vehicle_id,remark:remark},
            success: function (result) {
                if(result.code == 1){
