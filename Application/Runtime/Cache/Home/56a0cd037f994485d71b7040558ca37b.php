                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" placeholder="请输入车牌号" name="vehicle_number"  value="<?php echo ($list["vehicle_number"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="vehicle_type" id="vehicle_type" style="line-height: 34px;height: 34px;">
                                                ...
                                                <?php if(is_array($type_list)): foreach($type_list as $key=>$v): ?><option <?php if($list['vehicle_type'] == $v['id']): ?>selected<?php endif; ?> value="<?php echo ($v["id"]); ?>" ><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                            </select>
                                        </div>
