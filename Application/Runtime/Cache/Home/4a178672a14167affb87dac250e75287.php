                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?php echo U('home/GameAdd/upload_thumb');?>" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">VIP图标</font></font></label>

                                        <div class="controls">

                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="dan_upload_img_div1" style="border: none;;">
                                                    <img src="<?php echo $list['icon'];?>" style="max-height: 150px;border:1px solid #ddd;" alt=""/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $is_edit?'修改VIP图标':'上传VIP图标';?></font></font></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">VIP名称</font></font></label>

                                        <div class="controls">
                                            <input type="text" placeholder="请输入VIP名称" name="vip_name"  value="<?php echo ($list["vip_name"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">自动升级购卡数</font></font></label>

                                        <div class="controls">

                                            <input type="number" placeholder="自动升级需要购买的房卡数量" name="target"  value="<?php echo ($list["target"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="number" placeholder="请输入百分比" name="discount"  value="<?php echo ($list["discount"]); ?>" class="m-wrap medium"> <span style="padding-top: 9px;display: inline-block;">%</span>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">购买VIP价格</font></font></label>

                                        <div class="controls">

                                            <input type="text" placeholder="直接购买升级价格" name="price"  value="<?php echo ($list["price"]); ?>" class="m-wrap medium">
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">购买VIP赠送房卡</font></font></label>

                                        <div class="controls">

                                            <input type="number" placeholder="直接购买VIP赠送房卡数" name="send_num"  value="<?php echo ($list["send_num"]); ?>" class="m-wrap medium">
                                        </div>
...
<script>
    ...
    function SubmitData(img){
        var vip_name = $.trim($("*[name='vip_name']").val());
        var target = $.trim($("*[name='target']").val());
        var discount = $.trim($("*[name='discount']").val());
        var price = $.trim($("*[name='price']").val());
        var send_num = $.trim($("*[name='send_num']").val());
        ...
        $.ajax({
            ...
            data:{vip_name:vip_name,target:target,discount:discount,price:price,send_num:send_num,img:img,is_edit:is_Edit},
            success: function (result) {
                if(result.code == 1){
